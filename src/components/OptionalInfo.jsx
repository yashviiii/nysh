...
export const OptionalInformation = ({ formData, updateFormData }) => {
  const repaymentOptions = ["On Time", "Delayed", "Default"];
    ...
    <>
      ...
      <div className="row">
        <div className="input2">
          <input
            ...
            placeholder="Lender Name"
            value={lenderName}
            onChange={(e) => updateFormData({ ...formData, lenderName: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="row">
        <div className="input2">
          <input
            ...
            placeholder="Outstanding Loan Amount"
            value={loanAmount}
            onChange={(e) => updateFormData({ ...formData, loanAmount: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="row">
        <div className="input2">
          <select
            className="textfield"
            onChange={(e) => updateFormData({ ...formData, repaymentStatus: e.target.value })}
            value={repaymentStatus}
          >
            <option value="">Select Repayment Status</option>
            {repaymentOptions.map((option, index) => (
      ...
      <div className="row">
        <div className="input2">
          <textarea
            ...
            placeholder="Additional Notes/Comments"
            value={comments}
            onChange={(e) => updateFormData({ ...formData, comments: e.target.value })}
          />
        </div>
      </div>
    </>
