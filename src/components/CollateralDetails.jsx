...
// export const CollateralDetails = ({ formData, updateFormData }) => {
...
//   // Ensure formData.collaterals is initialized as an array
//   const collaterals = formData.collaterals || [{ type: "", value: "", ownership: "", description: "" }];

//   const addCollateral = () => {
//     const newCollaterals = [...collaterals, { type: "", value: "", ownership: "", description: "" }];
//     updateFormData({ ...formData, collaterals: newCollaterals });
//   };
...
export const CollateralDetails = ({ formData, updateFormData }) => {
  ...
  const ownershipTypes = ["Self-Owned", "Family-Owned", "Third Party-Owned"];

  // Ensure formData.collaterals is initialized as an array
  const collaterals = formData.collaterals || [
    { type: "", value: "", ownership: "", description: "" },
  ];
  ...
  return (
    <>
      {collaterals.map((collateral, index) => (
        <div key={index} className="list">
          ...
          {collaterals.length > 1 && (
            <button onClick={() => removeCollateral(index)} className="remove-button">
              Remove Collateral
            </button>
          )}
        </div>
      ...
      <button onClick={addCollateral} className="add-button">
        Add a Collateral
      </button>
    </>
  );
